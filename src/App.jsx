...
const DICTIONARY = {
  en: {
    ...
    about: {
      ...
      stats: ['Cities', 'Runway Shows', 'Commercial & Editorial opportunities'],
    },
    masterclasses: {
      ...
      modalClose: 'Close',
      schedule: [
        { city: 'Grenoble', date: '14th and 15th of August', venue: 'Maison des Arts, Grenoble' },
        { city: 'Paris', date: 'The following Saturday and Sunday', venue: 'Atelier Lumiere, Paris' },
        { city: 'Lyon', date: 'The weekend after', venue: 'Maison de la Mode, Lyon' },
        { city: 'Madrid', date: 'The weekend after', venue: 'Galeria Cero, Madrid' },
        { city: 'Bruxelles', date: 'The weekend after', venue: 'Galerie Royale, Bruxelles' },
        { city: 'Milan', date: 'The weekend after', venue: 'Via Montenapoleone Studio, Milan' },
      ],
    },
    gallery: {
  ...
  fr: {
    ...
    masterclasses: {
      ...
      schedule: [
        ...
        { city: 'Bruxelles', date: 'Le week-end suivant', venue: 'Galerie Royale, Bruxelles' },
        { city: 'Milan', date: 'Le week-end suivant', venue: 'Via Montenapoleone Studio, Milan' },
      ],
    },
    gallery: {
  ...
  es: {
    ...
    masterclasses: {
      ...
      schedule: [
        ...
        { city: 'Lyon', date: 'El fin de semana siguiente', venue: 'Maison de la Mode, Lyon' },
        { city: 'Madrid', date: 'El fin de semana siguiente', venue: 'Galeria Cero, Madrid' },
        { city: 'Bruxelles', date: 'El fin de semana siguiente', venue: 'Galerie Royale, Bruxelles' },
        { city: 'Milan', date: 'El fin de semana siguiente', venue: 'Via Montenapoleone Studio, Milan' },
      ],
    },
    gallery: {
  ...
  it: {
    ...
    masterclasses: { eyebrow: 'Reclutamento Masterclass', title: 'Workshop in pi\u00f9 citt\u00e0 per entrare nell\'ecosistema DUNEX.', register: 'Iscriviti', modalTitle: 'Iscriviti a', modalName: 'Nome', modalEmail: 'Email', modalPhone: 'Telefono', modalCity: 'Citt\u00e0', modalMessage: 'Messaggio', modalPlaceholder: 'Parlaci dei tuoi obiettivi nel modeling', modalSubmit: 'Invia', modalClose: 'Chiudi', schedule: [
      ...
      { city: 'Madrid', date: 'Il fine settimana successivo', venue: 'Galeria Cero, Madrid' },
      { city: 'Bruxelles', date: 'Il fine settimana successivo', venue: 'Galerie Royale, Bruxelles' },
      { city: 'Milan', date: 'Il fine settimana successivo', venue: 'Via Montenapoleone Studio, Milan' },
    ] },
    gallery: {
  ...
  pt: {
    ...
    masterclasses: { eyebrow: 'Recrutamento Masterclass', title: 'Workshops em varias cidades para entrar no ecossistema DUNEX.', register: 'Registar', modalTitle: 'Registar em', modalName: 'Nome', modalEmail: 'Email', modalPhone: 'Telefone', modalCity: 'Cidade', modalMessage: 'Mensagem', modalPlaceholder: 'Conta-nos os teus objetivos de modelagem', modalSubmit: 'Enviar', modalClose: 'Fechar', schedule: [
      { city: 'Grenoble', date: '14 e 15 de agosto', venue: 'Maison des Arts, Grenoble' },
      { city: 'Paris', date: 'No fim de semana seguinte', venue: 'Atelier Lumiere, Paris' },
      { city: 'Lyon', date: 'No fim de semana seguinte', venue: 'Maison de la Mode, Lyon' },
      { city: 'Madrid', date: 'No fim de semana seguinte', venue: 'Galeria Cero, Madrid' },
      { city: 'Bruxelles', date: 'No fim de semana seguinte', venue: 'Galerie Royale, Bruxelles' },
      { city: 'Milan', date: 'No fim de semana seguinte', venue: 'Via Montenapoleone Studio, Milan' },
    ] },
    gallery: {
